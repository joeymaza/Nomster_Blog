...
class BlogPost(db.Model):
    ...
    # bi-directional One-to-Many relationship between User/BlogPost Table
    author: Mapped['User'] = relationship("User", back_populates='posts')
    author_id: Mapped[int] = mapped_column(Integer, ForeignKey('users.id'))

    # parental relationship to Comment
...
class User(UserMixin, db.Model):
    ...
    # comment_author refers to the comment author property in the Comment class
...
class Comment(db.Model):
    ...
    # users.id refer to the id in User class, 'comments' refer to the comments property in User class.
    author_id: Mapped[int] = mapped_column(Integer, ForeignKey('users.id'))
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            # set up new_user for table, accessing data from form
            new_user = User(
